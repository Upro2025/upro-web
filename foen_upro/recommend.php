...
// ฟังก์ชันคำนวณระยะทาง (ประกาศฟังก์ชันเพียงครั้งเดียว)
...
// รับข้อมูลพิกัดจาก $_GET
$userLat = $_GET['lat'] ?? null;
$userLng = $_GET['lng'] ?? null;

// ตรวจสอบให้แน่ใจว่า $userLat และ $userLng มีค่าก่อนที่จะใช้
if ($userLat && $userLng) {
...
foreach ($categoryLabels as $label) {
    ...
    $categories[] = [
        ...
        'bg' => "$color-100",
        'text' => "$color-600",
        'icon' => 'M4 6h16M4 10h16M4 14h16M4 18h16' // ไอคอนสามารถปรับได้ตามต้องการ
    ];
    $i++;
}
?>
