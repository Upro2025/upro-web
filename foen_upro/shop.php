...
// Retrieve shop details from Supabase
$shop_id = $_GET['id'] ?? '';
$shop = null;
if ($shop_id !== '') {
...
// If no shop found, display an error
if (!$shop) {
...
// Retrieve menu details for the shop
$menus = null;
...
<main class="p-8 max-w-6xl mx-auto font-sans">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <!-- Left: Image + Address + Phone + Time + Google Maps -->
